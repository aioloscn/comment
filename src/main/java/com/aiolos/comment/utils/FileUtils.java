...
public class FileUtils {
    ...
    public static MultipartFile fileToMultipart(String filePath, String originalFilename, String contentType) {
        try {
            // File转换成MutipartFile
            File file = new File(filePath);
            FileInputStream inputStream = new FileInputStream(file);
            MultipartFile multipartFile = new MockMultipartFile(file.getName(), originalFilename, contentType, inputStream);
            return multipartFile;
        } catch (IOException e) {
